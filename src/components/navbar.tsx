    ...
    <Navbar onMenuOpenChange={setIsMenuOpen} isBordered>
      <NavbarContent>
        ...
        >
          ...
          <p
            className={`font-bold bg-gradient-to-r from-teal-600 to-blue-500 via-sky-400 text-transparent bg-clip-text text-2xl ${titleFont.className}`}
          >
            Netplix
          </p>
        </NavbarBrand>
      ...
      <NavbarContent className="hidden sm:flex gap-4" justify="start">
        ...
        <NavbarItem isActive={false}>
          <Link href="#Series" color="foreground" aria-current="page">
            Series
          </Link>
        </NavbarItem>
        <NavbarItem>
      ...
      <NavbarContent justify="end">
        <NavbarItem className="hidden lg:flex">
          <Input
            value={params.get("query")?.toString() ? params.get("query")?.toString() : value}
